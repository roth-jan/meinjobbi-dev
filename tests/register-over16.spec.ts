...
test('navigate to interests screen (over 16)', async ({ page }) => {
  ...
  // Birthdate over 16 (e.g., 2007-01-01 = 17-18 years old)
  await page.locator('input[placeholder="Geburtsdatum"]').fill('2007-01-01');
